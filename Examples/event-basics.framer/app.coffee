...
# Set up layers
layer1 = new Layer 
	x:50, y:50, width:140, height: 140, backgroundColor: "#0079c6", borderRadius: "6px"
layer2 = new Layer 
	x:220, y:50, width: 140, height: 140, backgroundColor: "#26b4f6", borderRadius: "6px"
layer3 = new Layer 
	x:390, y:50, width: 140, height: 140, backgroundColor: "#7ed6ff", borderRadius: "6px"
