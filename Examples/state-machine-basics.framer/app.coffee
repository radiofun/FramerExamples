...
layerB = new Layer width:50, height:50, y:200, backgroundColor:"orange"

layerB.states.add
	stateA: {y:200, rotation:180}
	stateB: {y:100, rotation:60}
	stateC: {x:40, rotation:0, blur:10}
...
layerC = new Layer width:50, height:50, y:400, backgroundColor:"blue"
