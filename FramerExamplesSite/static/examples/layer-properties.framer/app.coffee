...
layerB = new Layer 
	width:50, height:50, x:50, y:150, backgroundColor:"red"

# You can also set them at any time afterwards
layerC = new Layer 
	width:50, height:50, x:50, y:250, backgroundColor:"green"
layerC.rotation = 10

# Here are some more properties to play with, and you can also see how to set multiple properties at once.
layerD = new Layer 
	width:100, height:100, x:150, y:350, backgroundColor:"orange"
